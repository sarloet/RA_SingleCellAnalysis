...
# Run Subcluster Function
sce.Tcell<-SUBCLUSTER(sce, "T cell", clust_param="leiden", k_param=50, merge_order,batchcorr=FALSE)
...
# Run Subcluster Function
sce.Myeloid<-SUBCLUSTER(sce, "Myeloid", clust_param="leiden", k_param=50, merge_order, batchcorr=FALSE)
...
plotReducedDim(sce.Endothelial, dimred = "MNN_UMAP_SC_reduced", colour_by = "ACTA2" , order_by="ACTA2" ,point_alpha=1,point_size=0.5) +scale_colour_gradient(name = "ACTA2",low = "lightgrey", high = "red")
