...
rownames(spe) <- uniquifyFeatureNames(rowData(spe)$UniqID, rowData(spe)$symbol)
data.frame(rowData(spe))


#plotSpots(spe, annotate="DCN")
plotVisium(spe, fill = "HOXC10", highlight = "in_tissue")
#p2 <- plotVisium(spe, annotate = "DCN", highlight = "in_tissue")
...
ggcorrplot::ggcorrplot(
  ...
  ggplot2::theme(
    ...
    axis.text = ggplot2::element_text(size = 40, vjust = 0.7,face = "bold"))
...
sce$SpatialAnno[sce$Annotation_L2 %in% c("TREM2+ MP","FOLR2+ MP")] <- "TR Macrophage"
...
sce$SpatialAnno[sce$Annotation_L2 %in% c("Smooth muscle cell")] <- "SMC"
