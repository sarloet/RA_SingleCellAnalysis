...
```{r PlotUMAPAB1}
#Run UMAP
sce.BatchR <- runUMAP(sce.BatchR ,name = "MNN_UMAP", dimred = "MNN")#subset.row = rownames(sce.BatchR)[rowData(sce.BatchR)[["is_hvg"]]]
sce.BatchR.r <- runUMAP(sce.BatchR ,name = "MNN_UMAP_reduced", dimred = "MNN_reduced")
sce.BatchR.r.h <- runUMAP(sce.BatchR ,name = "MNN_UMA_reduced_hvg", dimred = "MNN_reduced", subset.row = rowData(sce.BatchR)$is_hvg)
```
