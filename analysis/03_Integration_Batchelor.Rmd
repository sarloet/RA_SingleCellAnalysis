...
#Perform fastMNN
bpstart(bpp)
sce.Batchelor <- fastMNN(sce.Batchelor, batch=sce.Batchelor$Sample, subset.row = rownames(sce.Batchelor)[rowData(sce.Batchelor)[["is_hvg"]]],prop.k=0.01, correct.all=TRUE,BPPARAM = bpp)#merge.order = merge_order,prop.k=0.05
bpstop(bpp)
