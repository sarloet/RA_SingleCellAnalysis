...
merge_order <- list( 
          ...
          list("SynBio_028", "SynBio_076","SynBio_081", "SynBio_087", "SynBio_130")),#MCP,"SynBio_049"
...
#Perform fastMNN
bpstart(bpp)
sce.Batchelor <- fastMNN(sce.Batchelor, batch=sce.Batchelor$Sample, subset.row = rownames(sce.Batchelor)[rowData(sce.Batchelor)[["is_hvg"]]],prop.k=0.01, merge.order = merge_order, correct.all=TRUE,BPPARAM = bpp)
bpstop(bpp)
