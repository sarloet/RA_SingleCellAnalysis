...
```{r }
# Testing
res <- testNhoods(sce.milo, design = ~ 0 + Joint.Location, design.df = design, model.contrasts = "Knee-Wrist", reduced.dim = "MNN", fdr.weighting="graph-overlap") # fdr.weighting="graph-overlap"
...
umap_pl <- plotReducedDim(sce.milo, dimred = "MNN_UMAP", colour_by="label", text_by = "label", 
