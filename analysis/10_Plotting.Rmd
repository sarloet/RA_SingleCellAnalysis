...
grid.arrange(p$`Endothelial cell` + theme(legend.position="none"), 
             ...
             p$`Smooth muscle cell` + theme(legend.position="none",axis.line.y=element_blank(),axis.text.y=element_blank(),axis.ticks.y=element_blank()), 
             ...
             ncol = 10, widths = c(1.5/11, 1/11, 1/11, 1/11, 1/11, 1/11, 1/11, 1/11, 1/11, 1.5/11))
