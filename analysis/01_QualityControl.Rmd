...
colData(sce)$qc.count_manual <- sce$sum < 1000 # Cells have at least a count of 400 |sce$sum > 100000
...
colData(sce)$qc.mito <- isOutlier(sce$subsets_Mito_percent,nmads=2, type="higher",batch =sce$Sample)
