...
find_de_MAST_RE <- function(sce,C_type){
  ...
  # create a MAST object
    ...
    contrasts(colData(sca)$group)='contr.joint'
    ...
    #test contrasts symbolically
    lr_cond_KvM <- lrTest(zlmCond, Hypothesis('groupKnee - groupMCP'))
    lr_anova_KvW <- lrTest(zlmCond, Hypothesis('groupKnee - groupWrist'))
    lr_anova_MvW <- lrTest(zlmCond, Hypothesis('groupMCP - groupWrist'))
