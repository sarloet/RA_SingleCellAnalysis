...
top2 <- bind_rows(lapply(tbl_fil, top_n, 4, p_adj.loc))
format(top2[, -ncol(top2)], digits = 2)
```


```{r DE}
kFibroblast <- tbl[["Fibroblast"]]
head(format(k1[, -ncol(kFibroblast)], digits = 2))
...
top2 <- bind_rows(lapply(tbl_fil, top_n, 25, p_adj.loc))
format(top2[, -ncol(top2)], digits = 2)
```
