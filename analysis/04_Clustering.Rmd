...
colData(sce.cluster)$louvain <- clusterCells(sce.cluster, use.dimred = "MNN_reduced", BLUSPARAM = SNNGraphParam(k=10,cluster.fun="louvain",BPPARAM =bpp))
...
colData(sce.cluster)$leiden <- clusterCells(sce.cluster, use.dimred = "MNN_reduced", BLUSPARAM = SNNGraphParam(k=80,cluster.fun="leiden",BPPARAM =bpp))
