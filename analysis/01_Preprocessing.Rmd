...
#Remove Cells with very low expression of less than 150 genes expressed and cells with low count
...
#### Save filtered Data
```{r SaveDataFiltered}
saveRDS(sce.filtered, file =paste0(path,'/output/01_sce_Preprocessing_filtered.rds'))
```
