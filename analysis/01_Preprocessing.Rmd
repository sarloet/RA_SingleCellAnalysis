...
colData(sce)$qc.count_manual <- sce$sum < 400  # Cells have at least a count of 400 |sce$sum > 100000
...
colData(sce)$qc.genexp <- isOutlier(sce$detected,nmads=4, log=TRUE, type="both",batch =sce$Sample)
