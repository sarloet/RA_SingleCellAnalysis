...
colData(sce)$qc.count_manual <- sce$sum < 1000 # Cells have at least a count of 1000
...
#Plot Mito percent
plotColData(sce, y="subsets_Mito_percent",colour_by = "discard",order_by= ) + ggtitle("Mito percent") +guides(colour=guide_legend(title="Discarded"))
...
vst_out <- vst(umi = counts,latent_var = 'log_umi',residual_type = "pearson",return_gene_attr = TRUE,return_cell_attr = TRUE)
