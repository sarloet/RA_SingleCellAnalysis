...
colData(sce)$qc.count_manual <- sce$sum < 750  # Cells have at least a count of 400 |sce$sum > 100000
colData(sce)$qc.genexp_manual <- sce$detected < 500 |sce$detected > 11000 # Cells have at least 300 genes expressed
