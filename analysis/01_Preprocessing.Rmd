...
```{r QcPlots3}
#Plot Total count
plotColData(sce, x="Sample", y="sum",other_fields="Sample",colour_by = I(sce$qc.count | sce$qc.count_manual)) + 
...
```{r QcPlots4}
#Plot Detected Genes
plotColData(sce, x="Sample", y="detected", other_fields="Sample",colour_by = I(sce$qc.genexp | sce$qc.genexp_manual)) + 
    facet_wrap(~Sample, nrow=1, scales = "free_x") + 
    scale_y_log10() + 
...
```{r QcPlots5}
#Plot Mito percent
plotColData(sce, x="Sample", y="subsets_Mito_percent", other_fields="Sample",colour_by = I(sce$qc.mito | sce$qc.mito_manual)) + 
    facet_wrap(~Sample, nrow=1, scales = "free_x") +
