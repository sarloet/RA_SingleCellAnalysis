...
colData(sce)$qc.count_manual <- sce$sum < 400 # Cells have at least a count of 1000
colData(sce)$qc.genexp_manual <- sce$detected < 300 | sce$sum > 100000 # Cells have at least 200 genes expressed
