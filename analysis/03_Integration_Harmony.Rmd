...
```{r}
#Plot PCA after data integration
plotReducedDim(sce.BatchR, dimred="harmony", colour_by="Joint.Location") + ggtitle("PCA after data integration with harmony")
```
### Facet by Sample
```{r}
...
plotReducedDim(sce.BatchR, dimred="harmony", colour_by="Joint.Location") + ggtitle("PCA after data integration with harmony")+ facet_wrap(~sce.BatchR$Joint.Location)
