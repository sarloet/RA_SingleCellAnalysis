...
```{r}
#Run UMAP
sce.BatchR <- runUMAP(sce.BatchR, dimred="harmony", subset_row=rowData(sce)$is_hvg, min_dist = 0.1, n_neighbors=25, name="harmony_UMAP")
sce.BatchR <- runUMAP(sce.BatchR, dimred="harmony_reduced", subset_row=rowData(sce)$is_hvg, min_dist = 0.1, n_neighbors=12, name="harmony_reduced_UMAP")
```
